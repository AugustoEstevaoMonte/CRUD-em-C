...
void excluirFisicamenteCartao (FILE **arqUser, char nome[]){//mudar int pra void
	FILE *arqAux = fopen("infoCard.aux", "a+b");
	struct tUsuario usr;
	...
	while(fread(&usr, sizeof(usr), 1, *arqUser))
